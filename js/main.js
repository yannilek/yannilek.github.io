const cards = [
  {
    ...
    color: 'violet',
    text: 'Comprendre les besoins de chacun.<br>Définir des <span>avantages</span> accessibles <span>pour tous</span> à Toulouse et ailleurs.',
  ...
  },
  {
    ...
    cfdText: 'Avec la CFDT soyez <span>accompagné</span>.',
  },
  {
  ...
  },
  {
    ...
    color: 'volt',
    text: 'Négocier l\'évolution du temps de travail.<br>Préserver <span>l\'harmonie</span> entre <span>vie professionnelle</span> et <span>vie personnelle</span> pour tous.',
    cfdText: 'Avec la CFDT soyez <span>représenté</span>.',
  },
];
